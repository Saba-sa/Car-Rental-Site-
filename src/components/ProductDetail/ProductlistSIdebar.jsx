    ...
    <section className="container py-24 relative dark:text-white dark:bg-black">
      <div className="w-full max-w-screen-2xl  mx-auto px-4 md:px-8">
        ...
        <div className="grid grid-cols-12">
          <div
            className="inline md:hidden  cursor-pointer  md:d-none font-medium text-base leading-7 text-black mb-5 dark:text-white  relative w-full max-w-sm"
          ...
          >
            ...
            <span className="absolute top-1/2 -translate-y-1/2 left-12 z-50">
              {" "}
              Filters
            </span>
          </div>
